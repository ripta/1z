...
pub const primitives = [_]Primitive{
    ...
    .{ .name = "#take", .stack_effect = "seq n -- seq'", .doc = "Take first n elements of sequence. An operand that is neither a native sequence nor an iterator is routed through >iterator. A coerced operand yields an iterator.", .func = nativeTake },
    .{ .name = "#drop", .stack_effect = "seq n -- seq'", .doc = "Drop first n elements of sequence. An operand that is neither a native sequence nor an iterator is routed through >iterator. A coerced operand yields an iterator.", .func = nativeDrop },
    .{ .name = "#sort", .stack_effect = "seq quot: ( a b -- ? ) -- array", .doc = "Sort sequence using comparator quotation. Returns a new sorted array. An operand that is neither a native sequence nor an iterator is routed through >iterator.", .func = nativeSort },
    .{ .name = "#sort-by", .stack_effect = "seq quot: ( elem -- key ) -- array", .doc = "Sort sequence by keys extracted via quotation. Keys compared with natural ordering. An operand that is neither a native sequence nor an iterator is routed through >iterator.", .func = nativeSortBy },
