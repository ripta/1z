...
pub fn popInteger(ctx: *Context) !i64 {
    ...
    return switch (val) {
        .integer => |i| i,
        .boolean, .string, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
...
pub fn popBoolean(ctx: *Context) !bool {
    ...
    return switch (val) {
        .boolean => |b| b,
        .integer => |i| i != 0,
        .string, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popQuotation(ctx: *Context) !Quotation {
    ...
    return switch (val) {
        .quotation => |q| q,
        .integer, .boolean, .string, .symbol, .array, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popSymbol(ctx: *Context) ![]const u8 {
    ...
    return switch (val) {
        .symbol => |s| s,
        .integer, .boolean, .string, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popString(ctx: *Context) ![]const u8 {
    ...
    return switch (val) {
        .string => |s| s,
        .integer, .boolean, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popStackEffect(ctx: *Context) !StackEffect {
    ...
    return switch (val) {
        .stack_effect => |se| se,
        .integer, .boolean, .string, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
...
pub fn popVector(ctx: *Context) !*Vector {
    ...
    return switch (val) {
        .vector => |v| v,
        .integer, .boolean, .string, .symbol, .array, .quotation, .hash, .byte_array, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popByteArray(ctx: *Context) !*ByteArray {
    ...
    return switch (val) {
        .byte_array => |b| b,
        .integer, .boolean, .string, .symbol, .array, .quotation, .hash, .vector, .set, .mutable_map, .stream, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popStream(ctx: *Context) !*Stream {
    ...
    return switch (val) {
        .stream => |s| s,
        .integer, .boolean, .string, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .parameter, .module, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
...
pub fn popModule(ctx: *Context) !*Module {
    ...
    return switch (val) {
        .module => |m| m,
        .integer, .boolean, .string, .symbol, .array, .quotation, .hash, .vector, .byte_array, .set, .mutable_map, .stream, .parameter, .marker => error.TypeError,
        .stack_effect, .parse_time_marker, .error_value => error.TypeError,
    };
}
